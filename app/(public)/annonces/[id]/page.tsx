...
import FormulaireContact from "@/components/annonces/FormulaireContact";
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="space-y-3">
            <div className="relative h-80 w-full rounded-xl overflow-hidden bg-gray-100">
              ...
              {/* Badge type offre */}
              <span
                className={`absolute top-4 left-4 text-xs font-medium px-3 py-1 rounded-full z-10 ${
              ...
              {/* Bouton favori — haut droite de la photo principale */}
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              {annonce.nombrePieces > 0 && (
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-xs text-gray-500 mt-1">
                    Pièce{annonce.nombrePieces > 1 ? "s" : ""}
                  </div>
                </div>
              )}
              {annonce.nombreSanitaires > 0 && (
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <div className="text-xl font-semibold text-gray-900">
                    {annonce.nombreSanitaires}
                  </div>
                  <div className="text-xs text-gray-500 mt-1">
                    Salle{annonce.nombreSanitaires > 1 ? "s" : ""} de bain
                  </div>
                </div>
              )}
              {annonce.etage !== null && (
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {/* Contact + Favoris */}
          <div className="bg-white rounded-xl border border-gray-200 p-5 sticky top-24 space-y-3">
            <h2 className="text-sm font-medium text-gray-700 uppercase tracking-wide mb-1">
              Contacter l&apos;agent
            </h2>
            ...
            {/* Bouton favori variante detail */}
            <BoutonFavori annonceId={annonce.id} variante="detail" />
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            ...
            <p className="text-xs text-red-700 mt-2">
              Position approximative — la position exacte est communiquée après
